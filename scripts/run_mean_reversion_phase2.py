"""
Script to run backtests on Corrected Mean Reversion strategy (Oversold).
"""
...
def main():
    ...
    print("\n" + "="*70)
    print("PHASE 2: MEAN REVERSION (OVERSOLD LONG ENTRY)")
    print("="*70)
    ...
    # Initialize Corrected Mean Reversion Detector
    detector = MeanReversionDetector(
        rsi_threshold=settings.RSI_THRESHOLD, # Now 30
        profit_target=settings.MEAN_REVERSION_PROFIT_TARGET, # Now 0.10
        bb_period=settings.BB_PERIOD,
        bb_std_dev=settings.BB_STD_DEV
    )
